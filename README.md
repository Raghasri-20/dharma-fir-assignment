...
The Dharma FIR Assistant is an AI-powered system that analyzes First Information Reports (FIRs) in India, extracts structured entities, maps them to relevant legal sections, and generates comprehensive summaries. The system leverages Google's Gemini 2.5 Flash AI model for natural language understanding and uses a dynamically built legal knowledge baAse extracted from PDF and PowerPoint documents.
